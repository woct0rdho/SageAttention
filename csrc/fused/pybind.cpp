...
STABLE_TORCH_LIBRARY_IMPL(sageattention_fused, CUDA, m) {
    m.impl("quant_per_block_int8_scale_cuda", TORCH_BOX(quant_per_block_int8_scale_cuda));
    ...
    m.impl("mean_scale_fuse_quant_cuda", TORCH_BOX(mean_scale_fuse_quant_cuda));
}
