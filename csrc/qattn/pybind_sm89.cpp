...
STABLE_TORCH_LIBRARY_IMPL(sageattention_qattn_sm89, CUDA, m) {
    m.impl("qk_int8_sv_f8_accum_f32_attn", TORCH_BOX(qk_int8_sv_f8_accum_f32_attn));
    m.impl("qk_int8_sv_f8_accum_f32_fuse_v_scale_attn", TORCH_BOX(qk_int8_sv_f8_accum_f32_fuse_v_scale_attn));
    m.impl("qk_int8_sv_f8_accum_f32_fuse_v_scale_fuse_v_mean_attn", TORCH_BOX(qk_int8_sv_f8_accum_f32_fuse_v_scale_fuse_v_mean_attn));
    m.impl("qk_int8_sv_f8_accum_f32_attn_inst_buf", TORCH_BOX(qk_int8_sv_f8_accum_f32_attn_inst_buf));
    m.impl("qk_int8_sv_f8_accum_f16_attn_inst_buf", TORCH_BOX(qk_int8_sv_f8_accum_f16_attn_inst_buf));
    m.impl("qk_int8_sv_f8_accum_f32_fuse_v_scale_attn_inst_buf", TORCH_BOX(qk_int8_sv_f8_accum_f32_fuse_v_scale_attn_inst_buf));
